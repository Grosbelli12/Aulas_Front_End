...
// useReducer tem como sua principal função tornar mais fácil gerir os estados complexos de forma fácil e centralizada
// com ele você pode criar varias variaveis de estato para manipular, você consegue passar ações para ele também.
// o UseReducer começa começa com a função reducer que você cria fora dele, que será aonde você vai receber uma ação e irá devolver um novo estado
...
// dispatch é a função que você usa para iniciar a mudança de estado, você dispacha uma ordem, no caso do exmplo é  () => dispatch({ type: 'INCREMENTAR' })
// e entrega essa order a função reducer que tem o parâmetro action que recebe essa ordem
